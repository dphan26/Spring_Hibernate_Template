...
public class ConfigManager {
	...
	private ConfigManager() {
		...
		try {
			...
			if (inStream == null) {
				throw new RuntimeException("Could not find file '" + cfgFile
						+ "' in classpath");
			}
			...
			throw new RuntimeException("Failed to load config data from file '"
					+ cfgFile + "'", e);
		} finally {
	...
	public int getIntProperty(String propertyName) {
		...
		try {
			...
			throw new RuntimeException("Invalid value found for property '"
					+ propertyName + "'", e);
		}
	}
